		...
		<div class="md:col-span-12 lg:col-span-8 col-span-12">
			...
			<div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
				...
				<div class="mb-6">
					...
					<div class="grid grid-cols-2 gap-4">
						<div>
							...
							@error('first_name')
							<div class="text-red-500 text-sn" > {{$message}} </div>
							@enderror
					...
					<div class="mt-4">
						...
						<input wire:model='street' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" @error('street') border-red-500 @enderror id="address" type="text">
						</input>
						@error('street')
							<div class="text-red-500 text-sn" > {{$message}} </div>
							@enderror
					...
					<div class="grid grid-cols-2 gap-4 mt-4">
						...
						<div>
							...
							<input wire:model='zip_code' class="w-full rounded-lg border py-2 px-3 dark:bg-gray-700 dark:text-white dark:border-none" @error('zip') border-red-500 @enderror id="zip" type="text">
							</input>
							@error('zip_code')
							<div class="text-red-500 text-sn" > {{$message}} </div>
							@enderror
				...
				<ul class="grid w-full gap-6 md:grid-cols-2">
					...
					<li>
						<input wire:model='payment_method' class="hidden peer" id="hosting-big" type="radio" value="mercado_pago" />
					...
					<li class="py-3 sm:py-4" wire:key='{{$ci['producto_id']}}' >
						<div class="flex items-center">
							<div class="flex-shrink-0">
								<img alt="{{{$ci['nombre']}}}" class="w-12 h-12 rounded-full" src="{{ asset('storage/' . $ci['imagenes']) }}">
								</img>
							</div>
							...
							<div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
								{{Number::currency($ci['monto_total'], 'sol')}}
							</div>
						</div>
					</li>
