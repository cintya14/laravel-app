  ...
  <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
      <div>
        ...
        <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Compre una amplia variedad de productos tecnológicos .</p>
      ...
      <div class="relative ms-4">
        <img class="w-full rounded-md" src="{{ asset('storage/images/inicio.png') }}" alt="Image Description">
  ...
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold dark:text-gray-200"> Navegar<span class="text-blue-500"> Marcas
          </span> </h1>
      ...
      <p class="mb-12 text-base text-center text-gray-500">
       Elige entre una amplia variedad de marcas reconocidas
      </p>
    </div>
  </div>
  <div class="justify-center max-w-6xl px-4 py-4 mx-auto lg:py-0">
    <div class="grid grid-cols-1 gap-6 lg:grid-cols-4 md:grid-cols-2">
        ...
        <div class="bg-white rounded-lg shadow-md dark:bg-gray-800" wire:key="{{ $marca->id }}">
            <a href="/products?select_marcas[0]= {{$marca->id}}" class="">
              <!--<img src="class="object-cover w-full h-64 rounded-t-lg"> -->
              <img src="{{ asset('storage/' . $marca->imagen) }}" alt="{{ $marca->nombre }}" class="object-cover w-full h-64 rounded-t-lg">
...
<div class="bg-blue-200 py-20">
  <div class="max-w-xl mx-auto">
    <div class="text-center ">
      <div class="relative flex flex-col items-center">
        <h1 class="text-5xl font-bold dark:text-gray-200"> Navegar<span class="text-blue-500"> Categorias
          </span> </h1>
        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
          <div class="flex-1 h-2 bg-blue-200">
          </div>
      ...
      <p class="mb-12 text-base text-center text-gray-500">
        Elige entre una amplia variedad de categorías
      </p>
    </div>
  </div>
  ...
  <div class="max-w-[85rem] px-4 sm:px-6 lg:px-8 mx-auto">
    <div class="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-6">
      ...
      <a class="group flex flex-col bg-white border shadow-sm rounded-xl hover:shadow-md transition dark:bg-slate-900 dark:border-gray-800 dark:focus:outline-none dark:focus:ring-1
       dark:focus:ring-gray-600" href="/products?select_categorias[0]={{$categoria->id}}" wire:key="{{ $categoria->id }}">
        <div class="p-4 md:p-5">
          <div class="flex justify-between items-center">
            <div class="flex items-center">
              <img class="h-[2.375rem] w-[2.375rem] rounded-full" src="{{ asset('storage/' . $categoria->imagen)}}" alt="{{ $categoria->nombre }}">
              <div class="ms-3">
